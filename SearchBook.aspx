                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td><strong>Author:</strong>
                            ...
                            <br />
                            <ajaxToolkit:Rating ID="Rating1" runat="server" ReadOnly="True" WaitingStarCssClass="filled" StarCssClass="filled" FilledStarCssClass="filled" EmptyStarCssClass="empty" CurrentRating=<%# Eval("avgRating") %>></ajaxToolkit:Rating>
                            ...
                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl='<%# "UpdateBook.aspx?bookid="+Eval("BookID") %>'>Edit Book..</asp:HyperLink>
                            <br />
